...
const Card = ({ product }) => {
  ...
  return (
    <section className="w-[160px] sm:w-[200px] md:w-[290px] bg-white mx-auto space-y-4 rounded-md text-black border border-white shadow-md dark:bg-[#18181B] transition-transform transform hover:scale-105 hover:shadow-lg">
      {/* Card Image */}
      <section className="relative w-full h-[150px] lg:h-[200px]">
        <Image
      ...
      <section className="lg:p-2 px-1">
        ...
        <div className="flex items-center space-x-1">
          {Array.from({ length: product?.ratingCount || 5 }).map((_, index) => (
            <svg
              key={index}
        ...
        <section className="lg:mt-3 flex flex-col md:flex-row items-center justify-between">
